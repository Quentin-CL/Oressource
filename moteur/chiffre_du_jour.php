...
try {
    $bilans = bilan_transactions_espece(
        $bdd,
        $time_debut,
        $time_fin,
        $numero
    ...
    echo json_encode(['chiffre_du_jour' => $bilans['chiffre_degage_vente'] + $bilans['chiffre_degage_transaction'] - $bilans['remb_somme']], JSON_FORCE_OBJECT);
} catch (Exception $e) {
