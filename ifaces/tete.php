          ...
          <?php if (is_allowed_vente()) { ?>
            <li class="nav navbar-nav dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                ?>
                    <li>
                      <a href="../ifaces/ventes.php?numero=<?= "{$point_vente['id']}"; ?>"><?= $point_vente['nom']; ?></a>
                    </li>
                <?php
                  }
                }
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <?php if ($can_verif) { ?>
                  ...
                  <li>
                    <a href="../ifaces/verif_vente.php?date1=<?= $now_date; ?>&date2=<?= $now_date; ?>&numero=1">Vérifier les ventes et les transactions</a>
                  </li>
                  <li class="divider"></li>
                <?php } ?>
